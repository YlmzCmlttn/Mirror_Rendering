...
public class ProjectionCamera : MonoBehaviour {
    ...
    private void Start() {
        ...
        m_RenderTexture = new RenderTexture(m_TextureWidth, m_TextureHeight, 24, RenderTextureFormat.ARGB32);
        ...
        m_Camera.clearFlags = Camera.main.clearFlags;
        m_Camera.targetTexture = m_RenderTexture;

        m_SurfaceRenderer.material.mainTexture = m_RenderTexture;
    }
    ...
    public void Update() {
        Vector3 mainCameraPosition = m_MainCamera.transform.position;
        Vector3 toCamera = mainCameraPosition - m_ProjectionPlane.transform.position; ;
        Vector3 reflectedPos = mainCameraPosition - 2 * Vector3.Dot(toCamera, m_ProjectionPlane.m_NormalDir) * m_ProjectionPlane.m_NormalDir;
